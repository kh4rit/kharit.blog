...
Perform activities described here at your own peril. During testing mbsync for some reason recreated my messages, so I loosed all dates in them. This is why I recomend to do testing not on your real account. You can change to the real one after everything is set up properly.
